...
pickle_file = ROOT+'/devJAMS/Data/Kaggle Amazon Data/save.pickle'
...
def predict(x_batch):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            saver.restore(sess, ROOT+"/devJAMS/Data/Kaggle Amazon Data/runs/model-14400")                     
...
def real_time_predict_tester():
    ...
    root_path = ROOT+'/devJAMS/Data/Gold Standard Data/op_spam_v1.4/positive_polarity/truthful_from_TripAdvisor/fold'
    list_of_reviews = []
    for i in range(1, 6):
